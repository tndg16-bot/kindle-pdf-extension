    ...
    <main className="flex min-h-screen flex-col items-center overflow-x-hidden pt-20">
      ...
      <footer className="w-full py-20 text-center border-t border-white/5 bg-black/20">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex justify-center gap-8 mb-8 text-zinc-300 font-medium">
            <a href="#" className="hover:text-teal-400 transition-colors">Philosophy</a>
            <a href="#" className="hover:text-teal-400 transition-colors">Methods</a>
            <a href="#" className="hover:text-teal-400 transition-colors">Sessions</a>
          </div>
