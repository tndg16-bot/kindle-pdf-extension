...
- [x] **[L2] 中タスク2-2: PDF詳細版デザイン作成**
  - [x] [L3] ライター型（4ページ）デザイン ✅ HTMLテンプレート作成済み
  - [ ] [L3] クリエイター型（4ページ）デザイン
  - [ ] [L3] コンサル型（4ページ）デザイン
  - [ ] [L3] ビルダー型（4ページ）デザイン
...
| 大タスク | 進捗 | 担当 |
|----------|------|------|
| L1-1: 動線設置 | 3/4 ✅ | Kai, Mia |
| L1-2: PDF作成 | 1/3 🔄 | Codex, Mia, Sora |
| L1-3: テスト・デプロイ | 0/3 | Sage, Leo |
